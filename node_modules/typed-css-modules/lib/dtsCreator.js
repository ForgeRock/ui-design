...
var DtsContent = function () {
  ...
  _createClass(DtsContent, [{
    ...
    get: function get() {
      ...
      return ['declare const styles: {'].concat(_toConsumableArray(this.resultList.map(function (line) {
        return '  ' + line;
      })), ['};', 'export = styles;', '']).join(_os2.default.EOL) + this.EOL;
    }
  }, {
    key: 'tokens',
    get: function get() {
